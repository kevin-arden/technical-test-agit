...
import { addUser } from '../hooks/slice'
    ...
    <div className="container mx-auto">
      <div className="flex flex-col">
        ...
        <div className="mt-4 mx-8 flex flex-col align-center justify-center">
          <h3 className="mb-4 sm:align-center">Create User</h3>
          <Form className="flex justify-center flex-col align-center" onSubmit={e => handleSubmit(e)}>
            {inputText.map(item => (
              <Input className="mb-3" type={item.type} placeholder={item.placeholder} id={item.id} onChange={e => handleChange(e)} />
            ))}
            ...
            <DatePicker
              ...
              selected={container.expireddate}
              onChange={(date) => {
                handleChange({
                  target: {
                    id: "expireddate",
            ...
            />
            <select id="groupaccess" className="w-full drop-shadow-lg mb-1 p-2 rounded-md" onChange={e => handleChange(e)} >
